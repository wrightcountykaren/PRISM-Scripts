...
call changelog_update("04/10/2017", "Added error handling to ensure that a recipient is selected, also added error handling to make sure script gets into DORD.", "Charles Potter, Anoka")
