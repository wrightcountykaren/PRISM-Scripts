...
call changelog_update("05/10/2017", "Fixed an error message that occurs if user elects to send CP Initial Contempt Letter", "Wendy LeVesseur, Anoka County")
