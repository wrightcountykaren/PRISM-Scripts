...
'Adjustment Dialog-
BeginDialog Adjustment_Dialog, 0, 0, 206, 210, "Adjustment(s)"
  Text 5, 10, 65, 10, "Adjustment Reason"
  DropListBox 75, 10, 110, 10, "Please Select One"+chr(9)+"Error"+chr(9)+"Order"+chr(9)+"Overpayment", Reason_List
  Text 5, 35, 70, 15, "Affected Obligations"
  CheckBox 75, 35, 30, 15, "CCC", CCC_Obli_checkbox
  CheckBox 75, 50, 30, 10, "CCH", CCH_Obli_checkbox
  CheckBox 75, 60, 25, 10, "CMI", CMI_Obli_checkbox
  CheckBox 75, 70, 25, 10, "CMS", CMS_Obli_checkbox
  CheckBox 75, 80, 30, 10, "CSP", CSP_Obli_checkbox
  CheckBox 115, 40, 30, 10, "JCC", JCC_Obli_checkbox
  CheckBox 115, 50, 30, 10, "JCH", JCH_Obli_checkbox
  CheckBox 115, 60, 25, 10, "JME", JME_Obli_checkbox
  CheckBox 115, 70, 25, 10, "JMI", JMI_Obli_checkbox
  CheckBox 115, 80, 30, 10, "JMS", JMS_Obli_checkbox
  CheckBox 150, 40, 30, 15, "Other", Other_Obli_checkbox
  Text 0, 100, 45, 10, "Description"
  EditBox 45, 100, 145, 20, Descrip_Box
  Text 5, 135, 80, 15, "Total Amount Adjusted"
  EditBox 80, 135, 50, 15, Amount_Adjusted
  Text 60, 160, 60, 15, "Worker Signature"
  EditBox 120, 155, 45, 15, Worker_Signature
  ButtonGroup ButtonPressed
    OkButton 75, 190, 50, 15
    CancelButton 130, 190, 50, 15
EndDialog
