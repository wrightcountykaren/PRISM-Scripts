...
'-----The dialog-----
BeginDialog NOTES_main_menu_dialog, 0, 0, 436, 316, "NOTES main menu dialog"
  ButtonGroup ButtonPressed
    ...
    PushButton 10, 160, 100, 10, "MES Financial Docs Sent", NOTES_MES_Fin_docs_button
  ...
  Text 110, 160, 290, 10, "-- NEW 2/2016 Creates a CAAD note for recording documents sent to the parties."
EndDialog
