...
'-----The dialog-----
BeginDialog NOTES_main_menu_dialog, 0, 0, 437, 316, "NOTES main menu dialog"
  ButtonGroup ButtonPressed
    ...
    PushButton 10, 100, 50, 10, "CSENET Info", NOTES_CSENET_button
    PushButton 10, 120, 90, 10, "Date of the hearing (expro)", NOTES_date_of_hearing_expro_button
    PushButton 10, 140, 100, 10, "Date of the hearing (judicial)", NOTES_date_of_hearing_judicial_button
    PushButton 10, 160, 70, 10, "No Pay Months 1-4", NOTES_no_pay_months_button
    PushButton 10, 180, 50, 10, "Pay or report", NOTES_pay_or_report_button
    PushButton 10, 200, 70, 10, "Quarterly reviews", NOTES_quarterly_reviews_button
  ...
  Text 100, 120, 200, 10, "-- Date of the hearing template for expro."
  Text 110, 140, 200, 10, "-- Date of the hearing template for judicial."
  Text 80, 160, 340, 10, "-- Creates CAAD note for documenting non-payment enforcement actions."
  Text 60, 180, 240, 10, "-- CAAD note for case noting ''pay or report'' instances."
  Text 80, 200, 230, 10, "-- CAAD note for quarterly review processes."
