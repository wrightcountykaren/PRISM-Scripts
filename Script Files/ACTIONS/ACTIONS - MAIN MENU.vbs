...
'DIALOGS---------------------------------------------------------------------------
BeginDialog ACTIONS_main_menu_dialog, 0, 0, 381, 280, "ACTIONS Main Menu"
  ButtonGroup ButtonPressed
    ...
    PushButton 5, 135, 45, 10, "NCP Locate", ACTIONS_NCP_locate_button
    PushButton 5, 155, 60, 10, "PALC calculator", ACTIONS_PALC_calculator_button
    PushButton 5, 175, 60, 10, "Prorate Support", ACTIONS_prorate_support_button
    PushButton 5, 195, 65, 10, "Redirection Docs", ACTIONS_redirection_docs_button
    PushButton 5, 215, 75, 10, "Unreimb/Unins Docs", ACTIONS_un_un_button
    PushButton 5, 235, 85, 10, "Update Worker Signature", ACTIONS_update_worker_signature_button
    CancelButton 325, 260, 50, 15
  ...
  Text 70, 155, 230, 10, "-- Calculates voluntary and involuntary amounts from the PALC screen."
  Text 70, 175, 225, 10, "- Calculator for deteremining pro-rated support for partial months."
  Text 75, 195, 290, 10, "-- Creates redirection docs and redirection worklist items."
  Text 85, 215, 290, 10, "-- Prints DORD docs for collecting unreimbursed and unisured expenses."
  Text 95, 235, 280, 10, "-- NEW 04/2016!! -- Allows you to maintain a default signature that loads in all scripts."
  Text 40, 40, 330, 10, "-- NEW 04/2016!!! Leads you through performing a COLA. Adds CAAD note when completed."
  Text 55, 135, 320, 10, "-- NEW 04/2016!!! Walks you through processing an NCP locate."
EndDialog
