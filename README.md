BlueZone Scripts | PRISM-Scripts
===

Table of contents for this **DRAFT** README
---
...
_Please note_: script issues that only occur in the master branch are _not_ considered critical, as _the master branch is considered a test ground_. For this reason, **it is recommended that all master branch users also have access to the release branch**. This can easily be addressed by modifying the `use_master_branch` code within your agency's global variables file.
...
---
About the Installer/Configuration Utility (>>>note this doesn't work for CS yet<<<)
---
