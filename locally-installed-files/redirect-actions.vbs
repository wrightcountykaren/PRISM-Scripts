...
Else																														'If a Global Variables file is not found in the above directory...
	Set fso_command = run_another_script_fso.OpenTextFile("Scripts\SETTINGS - GLOBAL VARIABLES (LOCAL FLAVOR).vbs")			'...use the default BlueZone Scripts directory, and insert a custom "local flavor" Global Variables file, which can override the default selections.
End if
...
'LOADING SCRIPT
script_URL = script_repository & "/actions/~actions-menu.vbs"
