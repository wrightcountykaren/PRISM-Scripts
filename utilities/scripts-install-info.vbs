'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "scripts-install-info.vbs"
start_time = timer
...
Dim scriptwriter_array(6)
Dim email_button_array(6)
...
'Molly Kreger, Dakota
set scriptwriter_array(scriptwriter_counter) = new scriptwriter
scriptwriter_array(scriptwriter_counter).name			=	"Molly Kreger"
scriptwriter_array(scriptwriter_counter).agency			= 	"Dakota County"
scriptwriter_array(scriptwriter_counter).role			= 	"Trainer"
scriptwriter_array(scriptwriter_counter).formerrole		= 	"Child Support Specialist"
scriptwriter_array(scriptwriter_counter).email			= 	"Molly.Kreger@CO.DAKOTA.MN.US"
scriptwriter_counter = scriptwriter_counter + 1
...
'Gretchen, Dakota
set scriptwriter_array(scriptwriter_counter) = new scriptwriter
scriptwriter_array(scriptwriter_counter).name			=	"Gretchen Thornbrugh"
scriptwriter_array(scriptwriter_counter).agency			= 	"Dakota County"
scriptwriter_array(scriptwriter_counter).role			= 	"Child Support Specialist"
scriptwriter_array(scriptwriter_counter).formerrole		= 	"-"
scriptwriter_array(scriptwriter_counter).email			= 	"Gretchen.Thornbrugh@CO.DAKOTA.MN.US"
scriptwriter_counter = scriptwriter_counter + 1
...
BeginDialog Dialog1, 0, 0, 375, 450, "DHS BlueZone Scripts Info dialog"
  ButtonGroup ButtonPressed
	...
	'<<<<<<<<<<<<<<<<<<<<<THIS ISN'T PRESENT IN PRISM FOR SOME REASON SO I COMMENTED IT OUT, VKC 08/18/2016
