'GATHERING STATS----------------------------------------------------------------------------------------------------
name_of_script = "~utilities-menu-hydravb.vbs"
start_time = timer
...
BeginDialog menu_dialog, 0, 0, 506, 100, "Calculators menu dialog"
  ...
  ButtonGroup ButtonPressed
    ...
    PushButton 5, 5, 120, 10, "Update Worker Signature", btn_update_worker_signature
    Text 130, 5, 370, 10, "Updates your default worker signature."
    btn_update_worker_signature = button_incrementer
...
if ButtonPressed = btn_update_worker_signature then
    script_to_run = "https://raw.githubusercontent.com/MN-Script-Team/DHS-PRISM-Scripts/master/utilities/update-worker-signature.vbs"
end if
